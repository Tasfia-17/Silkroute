...
export const CONTRACTS = {
  // Testnet (Chain ID 71)
  testnet: {
    SILKROUTE: '0x11AADF85Af1c926d5395C4CEa04DBE68B03BdF60' as `0x${string}`,
    USDT0: '0x3EBA12Fbb3d7F5248502aD2c9696a78194beAd21' as `0x${string}`,
    AXCNH: '0xeD681263EBE64124114e1549FbB24b4EF94258E2' as `0x${string}`,
    PYTH: '0x2a24666769A823ec062200A43623e9e1150AcFb8' as `0x${string}`,
  },
